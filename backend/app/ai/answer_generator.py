...
def generate_answer(
    ...
    system_prompt = (
        ...
        "Ответ всегда должен относиться именно к услуге и проблеме, описанной пользователем. "
        "Если пользователь пишет про телевидение/ТВ/каналы/iptv, не описывай диагностику интернета и Wi‑Fi, "
        "если это явно не связано с его запросом. Если пишет про интернет, не отвечай про телевидение. "
